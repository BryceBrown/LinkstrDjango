	...
	return {
		...
		getActiveLinkById: function(id){
			if (activeLink) {
				...
				return $http.get('/demo/api/Links/' + id).then(function(results){
		...
		getDomains: function () {
			return $http.get('/demo/api/Domains/')
		...
		getStatsForDomain: function () {
			return this.getActiveDomain().then(function(domain){
				return $http.get('/demo/api/Domains/' + domain.id + '/Stats/')
				.then(function(results){
					return results.data;
				});
			})
		...
		getLinks: function (query) {
			return this.getActiveDomain().then(function(domain){
				return $http.get('/demo/api/Domains/' + domain.id + '/Links/' + query)
				.then(function(results){
					return results.data;
				});
			})
		...
		getStatsForLink: function (linkId) {
			return $http.get('/demo/api/Links/' + linkId + '/Stats/')
			.then(function(results){
				return results.data;
			});
		},
		...
		getShortenedUrl: function (link) {
			return $http.post('/demo/api/Links/', link)
		...
		getInterstitials: function () {
			if (!interstitials) {
				interstitials = $http.get('/demo/api/Interstitials/')
				.then(function(results){
					return results.data;
				});
			}
		...
		getInterstitialStats: function (interId, timestamp) {
			return $http.get('/demo/api/Interstitials/' + interId + "/Stats/?from=" + timestamp)
			.then(function(results){
				return results.data;
			});
		},
		...
		getOverallInterstitialStats: function(interId, timestamp) {
			return $http.get('/demo/api/Interstitials/' + interId + '/OverallStats/?from=' + timestamp)
			.then(function(results){
				return results.data;
			})
		},
		...
		generateLink: function(link) {
			return $http.post('/demo/api/Links/', link).then(function(result){
				return result.data;
			});
		},
	};
